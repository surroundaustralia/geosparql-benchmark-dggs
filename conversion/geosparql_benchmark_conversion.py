...
g = Graph().parse('https://raw.githubusercontent.com/OpenLinkSoftware/GeoSPARQLBenchmark/master/src/main/resources/gsb_dataset/dataset.rdf', format='xml')
...
geom_dggs_no_crs = {k: v.lstrip("<https://w3id.org/dggs/auspix> ") for k, v in geom_dggs.items()}
